...
my_granges_names = c("ranges_rep1","ranges_rep2")
...
plotRanges(ranges_rep1, 
           my_region = my_region, 
           my_title = "ranges #1 (n=6)", my_color = cbPalette[1])

plotRanges(ranges_rep2,  
           my_region = my_region, 
...
plotRanges(my_pooled_ranges[my_pooled_ranges$ranges_rep1 & my_pooled_ranges$ranges_rep2],
           my_region = my_region, 
...
plotRanges(my_pooled_ranges[my_pooled_ranges$ranges_rep2 & !(my_pooled_ranges$ranges_rep1)], 
           my_region = my_region, 
